...
const themeIcons = {
  light: <MdOutlineLightMode className='h-5 w-5 text-fg-text' />,
  dark: <MdOutlineDarkMode className='h-5 w-5 text-fg-text' />,
  system: <RiComputerLine className='h-5 w-5 text-fg-text' />
};
